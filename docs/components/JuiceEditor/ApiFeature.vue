<template>
    <BaseFeature :lang="lang" :translations="translations" gradientClass="bg-gradient-to-br from-cyan-500 to-blue-500"
        titleKey="api" :buttons="['extensible', 'documented', 'typed', 'stable']">
