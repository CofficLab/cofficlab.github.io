    ...
    <div class="relative w-full">
        <div class="relative aspect-[9/19.5]">
            ...
            <img v-if="showFrame"
                ...
                alt="iPhone frame" class="absolute inset-0 w-full h-full object-contain" />
                    ...
                    <div class="flex-none h-12 px-4 z-0 relative">
                        <div class="flex items-center h-full justify-between">
                            ...
                            <div class="flex items-center space-x-1.5">
                                ...
                                <!-- Wi-Fi图标 -->
                                <svg class="w-5 h-4 text-gray-700 dark:text-gray-200" viewBox="0 0 16 12"
                                    fill="currentColor">
                                    <path
                                ...
                                <div class="flex items-center space-x-0.5">
                                    <svg class="w-6 h-3.5 text-gray-700 dark:text-gray-200" viewBox="0 0 25 12"
