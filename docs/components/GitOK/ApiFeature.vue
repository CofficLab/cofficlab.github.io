<template>
    <BaseFeature :lang="lang" :translations="translations" gradientClass="bg-gradient-to-br from-orange-500 to-red-500"
        titleKey="apiTester" :buttons="['multiMethod', 'visualResponse', 'paramManager', 'history']">
...
const translations = {
    en: {
        ...
        description: 'Convenient API debugging environment',
        multiMethod: 'Multiple Methods',
    ...
    zh: {
        apiTester: 'API 测试工具',
        description: '便捷的 API 调试环境',
        multiMethod: '多种请求方法',
        visualResponse: '可视化响应',
        paramManager: '参数管理',
        history: '历史记录'
    }
}
